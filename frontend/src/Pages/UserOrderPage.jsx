                        ...
                        <div>
                            {
                                latestOrder &&
                                <>
                                    <div key={latestOrder.orderId} className='min-h-40 w-80 p-2 m-auto block sm:hidden shadow-md shadow-black/60 cursor-pointer rounded-md' >
                                                ...
                                                latestOrder.items.map(val => (
                                                    <div key={val._id} className='flex justify-between items-center' >
                                                        <div className='h-full w-[30%] flex justify-center items  ' >
                                                            <img src={food1} className='h-20 w-20 rounded-full object-cover' />
                                                        </div>
                                    ...
                                    <div key={latestOrder.orderId} className='h-full w-full lg:w-[80%] hidden sm:block p-4 border-2 border-black/60 rounded-md' >
                                            ...
                                            latestOrder?.items?.map(val => (
                                                <div key={val.orderId} className='h-32 w-full md:w-[90%] m-auto flex justify-around items-center border-b border-b-black/40 overflow-hidden' >
                                                    <div className='h-[80%] w-[40%] mr-4 flex justify-start items-start gap-4' >
                                                        <img src={val.image ? val.image : food1} onClick={() => handleClick(val)} className='h-full w-[50%] md:w-[40%] rounded-md cursor-pointer object-cover' />
